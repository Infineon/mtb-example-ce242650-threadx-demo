...
/* ThreadX to run in secure mode only */
#ifndef TX_SINGLE_MODE_SECURE
#define TX_SINGLE_MODE_SECURE
#endif

// /* ThreadX to run in non-secure mode only */
// #define TX_SINGLE_MODE_NON_SECURE 

#define TX_DISABLE_IAR_LIBRARY_SUPPORT
#define TX_PORT_DISABLE_LIBRARY_SUPPORT

/* ThreadX to use BASEPRI register instead of PRIMASK for interrupt masking */
#define TX_PORT_USE_BASEPRI
/* Priority level to be masked by ThreadX */
#define TX_PORT_ISR_SAFE_PRIORITY   4 
/* BASEPRI values  __NVIC_PRIO_BITS == 3*/
#define TX_PORT_BASEPRI (TX_PORT_ISR_SAFE_PRIORITY << (8 - 3))


/* IAR compiler thread-safe library */
#if defined(__ICCARM__)
#define TX_ENABLE_IAR_LIBRARY_SUPPORT
#endif 


/* clib-support Middleware */
#define TX_DISABLE_REDUNDANT_CLEARING


/* ThreadX Max thread priority level */
